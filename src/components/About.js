...
const About = () => (
  <div className="ab-info">
    ...
    <a className="cv-link" href="https://docs.google.com/document/d/1w6tg-esOivXjZ0izzSLLaS1Tf7EvQyjDWNKVFFEPppk/edit?usp=sharing"><button type="button" className="resume-link">Get My Resume</button></a>
  </div>
);
